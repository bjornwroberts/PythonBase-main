...
def getMyIP():
    try:
        ...
        # 
        #ip = ni.ifaddresses('en1')[ni.AF_INET][0]['addr'] #mac
        ip = socket.gethostbyname(hostname) #windows
        UDP_IP = ip
        UDP_PORT = 5005
        print(ip)
...
getMyIP()
hostname = socket.gethostname() #ip for windows
#ip = ni.ifaddresses('en1')[ni.AF_INET][0]['addr']
 #ask mclain how to do this on windows
ip = socket.gethostbyname(hostname) #ip for windows
#ip = "192.168.0.44"
UDP_IP = "0.0.0.0"
UDP_PORT = 5005
